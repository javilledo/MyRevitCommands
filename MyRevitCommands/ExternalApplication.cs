...
namespace MyRevitCommands
{
    internal class ExternalApplication : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            PushButtonData button = new PushButtonData("Button 1", "PlaceFamily", path, "MyRevitCommands.PlaceFamily");

            RibbonPanel panel = application.CreateRibbonPanel("My Commands", "Commands");

            // Add button image
            Uri imagePath = new Uri(@"C:\Users\javil\source\repos\MyRevitCommands\MyRevitCommands\desk.png");
